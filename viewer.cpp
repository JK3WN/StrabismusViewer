...
void Viewer::resetPhoto()
{
    ...
    ui->nine1->setPixmap(defimg.scaled(ui->nine1->width(),ui->nine1->height(),Qt::KeepAspectRatio));
    saveImg[4]=defimg.copy(0,0,defimg.width(),defimg.height());
    defimg.load(":/image/arrow2.PNG");
    ui->nine2->setPixmap(defimg.scaled(ui->nine2->width(),ui->nine2->height(),Qt::KeepAspectRatio));
    saveImg[5]=defimg.copy(0,0,defimg.width(),defimg.height());
    defimg.load(":/image/arrow3.PNG");
    ui->nine3->setPixmap(defimg.scaled(ui->nine3->width(),ui->nine3->height(),Qt::KeepAspectRatio));
    saveImg[6]=defimg.copy(0,0,defimg.width(),defimg.height());
    defimg.load(":/image/arrow4.PNG");
    ui->nine4->setPixmap(defimg.scaled(ui->nine4->width(),ui->nine4->height(),Qt::KeepAspectRatio));
    saveImg[7]=defimg.copy(0,0,defimg.width(),defimg.height());
    defimg.load(":/image/arrow6.PNG");
    ui->nine6->setPixmap(defimg.scaled(ui->nine6->width(),ui->nine6->height(),Qt::KeepAspectRatio));
    saveImg[8]=defimg.copy(0,0,defimg.width(),defimg.height());
    defimg.load(":/image/arrow7.PNG");
    ui->nine7->setPixmap(defimg.scaled(ui->nine7->width(),ui->nine7->height(),Qt::KeepAspectRatio));
    saveImg[9]=defimg.copy(0,0,defimg.width(),defimg.height());
    defimg.load(":/image/arrow8.PNG");
    ui->nine8->setPixmap(defimg.scaled(ui->nine8->width(),ui->nine8->height(),Qt::KeepAspectRatio));
    saveImg[10]=defimg.copy(0,0,defimg.width(),defimg.height());
    defimg.load(":/image/arrow9.PNG");
    ui->nine9->setPixmap(defimg.scaled(ui->nine9->width(),ui->nine9->height(),Qt::KeepAspectRatio));
    saveImg[11]=defimg.copy(0,0,defimg.width(),defimg.height());
